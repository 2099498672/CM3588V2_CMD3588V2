...
public:
    ...
    // CAN 相关方法
    virtual int open_can_device(const char* can_interface_name);
    virtual bool can_send(int fd, unsigned int can_id, unsigned char* buf);
    virtual bool can_recv(int fd, unsigned char* buf);
